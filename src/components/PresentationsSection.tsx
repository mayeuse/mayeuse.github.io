...
const mediaItems: MediaItem[] = [
  { type: 'pdf', src: '/documents/CapitolPosterDraft.pdf' },
  { type: 'image', src: Presentation2 },
  { type: 'instagram', src: 'https://www.instagram.com/reel/DDIXI3eJHQb/' },
  ...
  { type: 'image', src: Presentation7 },
  { type: 'youtube', src: 'https://www.youtube.com/embed/sb_m4tytao4', youtubeStart: 88 },
  { type: 'image-with-link', src: Presentation4, link: 'https://docs.google.com/presentation/d/1JAoad6QpkUi0HViixAxjg4qaAHSexjncuW9crRLL4Jg/edit?usp=sharing' },
];
  ...
  const renderMediaItem = (item: MediaItem, index: number) => {
    switch (item.type) {
      ...
      case 'instagram':
        return (
          <div className="w-full h-full flex items-center justify-center">
            <iframe
              src="https://www.instagram.com/reel/DDIXI3eJHQb/embed/"
      ...
      case 'youtube':
        return (
          <iframe
            src={`${item.src}?start=${item.youtubeStart}&autoplay=0`}
            className="w-full h-full rounded-lg"
  ...
  return (
    <section id="presentations" className="min-h-screen flex items-center justify-center px-[5%] relative z-10">
      <div className="flex items-center gap-8 w-full max-w-6xl">
        ...
        >
          {/* Previous item (faded) */}
          <div className="absolute left-0 z-0 opacity-30 scale-75 h-[300px] w-[200px] flex items-center justify-center">
          ...
          {/* Next item (faded) */}
          <div className="absolute right-0 z-0 opacity-30 scale-75 h-[300px] w-[200px] flex items-center justify-center">
